        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('comments.update', $comment->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('user_id')) has-error @endif">
                    ...
                    <input type="text" id="post_id-field" name="post_id" class="form-control" value="{{ is_null(old("post_id")) ? $comment->post_id : old("post_id") }}"/>
                    ...
                    <textarea class="form-control" id="body-field" rows="3" name="body">{{ is_null(old("body")) ? $comment->body : old("body") }}</textarea>
                       @if($errors->has("body"))
